    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('confirm_status', models.CharField(blank=True, choices=[('0', 'รอยืนยัน'), ('1', 'ยืนยันแล้ว'), ('2', 'ยืนยันบางส่วน'), ('3', 'ยกเลิก'), ('4', 'ยกยอด')], default='0', max_length=1, null=True, verbose_name='Status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qty', models.IntegerField(verbose_name='Qty')),
                ('confirm_qty', models.IntegerField(blank=True, default='0', null=True, verbose_name='Confirm Qty')),
                ('original_qty', models.IntegerField(blank=True, default='0', null=True, verbose_name='Original Qty')),
                ('summary_price', models.FloatField(blank=True, default='0', null=True, verbose_name='Summary Price')),
                ('remark', models.TextField(blank=True, null=True, verbose_name='Remark')),
                ('inv_status', models.CharField(blank=True, choices=[('0', 'รอยืนยัน'), ('1', 'ยืนยันแล้ว'), ('2', 'ยืนยันบางส่วน'), ('3', 'ยกเลิก'), ('4', 'ยกยอด')], default='0', max_length=1, null=True, verbose_name='inv Status')),
                ('ref_formula_id', models.CharField(blank=True, max_length=8, null=True, verbose_name='Formula ID')),
