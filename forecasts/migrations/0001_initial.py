    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('request_status', models.CharField(choices=[('0', 'รออนุมัติเปิด PR'), ('1', 'อนุมัติเปิด PR'), ('2', 'เปิด PR แล้ว'), ('3', 'ไม่อนุมัติ')], default='0', max_length=1, verbose_name='Request Status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('remark', models.TextField(blank=True, null=True, verbose_name='Remark')),
                ('forecast_status', models.CharField(choices=[('0', 'รออนุมัติเปิด PR'), ('1', 'อนุมัติเปิด PR'), ('2', 'เปิด PR แล้ว'), ('3', 'ไม่อนุมัติ')], default='0', max_length=1, verbose_name='Request Status')),
