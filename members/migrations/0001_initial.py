    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='members.department', verbose_name='Department ID')),
                ('formula_user_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='members.employee', verbose_name='Formula User ID')),
                ('factory_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='members.factory', verbose_name='Factory ID')),
                ('line_notification_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='members.linenotification', verbose_name='Line Notification ID')),
                ('position_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='members.position', verbose_name='Position ID')),
                ('section_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='members.section', verbose_name='Section ID')),
                ('supplier_id', models.ManyToManyField(blank=True, null=True, related_name='SetSupplier', to='members.supplier', verbose_name='Supplier ID')),
            ],
            options={
                'verbose_name': 'User',
