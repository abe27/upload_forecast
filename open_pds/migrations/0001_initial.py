# Generated by Django 4.2.8 on 2023-12-15 06:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pds_status', models.CharField(blank=True, choices=[(0, 'รอเปิด PO'), (1, 'เปิด PO บางส่วน'), (2, 'เสร็จสมบูรณ์'), (3, '-'), (4, '-')], default='0', max_length=1, null=True, verbose_name='PDS Status')),
